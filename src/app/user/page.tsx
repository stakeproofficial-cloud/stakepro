...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-10 bg-gradient-to-br from-pm-ink via-pm-char to-pm-brown-900 sm:items-start">
            <div className="flex justify-between items-center w-full px-4 mb-6 bg-[#3d3131]/60 backdrop-blur-md rounded-lg">
                ...
                <div className="flex-1 text-right">
                    ...
                    <div className="text-xs text-gray-500">Welcome To MoneyMartx</div>
                </div>
            </div>
            ...
            <section className="grid grid-cols-2 gap-3 mb-6 px-4 w-full">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-sm p-3 border border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                        <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h3 className="text-xs font-medium text-gray-700">My Invest Profit</h3>
                    </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-sm p-3 border border-purple-200">
                    <div className="flex items-center gap-2 mb-2">
                        <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <h3 className="text-xs font-medium text-gray-700">Team Commissions</h3>
                    </div>
            ...
            <section className="mb-6 w-full px-4">
                <h2 className="text-xl font-bold mb-4">3x Progress Bar</h2>
                <div className="w-full bg-gray-200 rounded-full h-4 relative">
                    <div
                        className="bg-gradient-to-r from-pm-gold-900 to-pm-gold-500 h-4 rounded-full transition-all duration-500"
