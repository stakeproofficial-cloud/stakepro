...
import { fetchTicket, replyToTicket, closeTicket, selectMessagesFor, selectTicketById } from "@/store/supportSlice";
...
export default function AdminTicketDetailPage() {
    ...
    const { loadingTicketId, replyingTicketId, closingTicketId, error } = useAppSelector((s) => s.support);
                            ...
                            <div key={msg.id} className={`p-4 rounded-lg ${msg.sender_role === "admin" ? "bg-blue-50 border border-blue-200" : "bg-gray-50 border border-gray-200"}`}>
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        <span className="font-medium">{msg.sender_role === "admin" ? "Support Staff" : "User"}</span>
                                        {msg.sender_role === "admin" && <span className="text-xs bg-blue-200 text-blue-800 px-2 py-0.5 rounded">ADMIN</span>}
                                    </div>
